...
print("FIXED BY RIO")
print("add my id line: http://line.me/ti/p/KTS6MCiOZe")
...
message = {
    "replyPesan":"ngapain ngetag, gelud sini kita.",
}
...
#==============================================================================# 
        if op.type == 5:
            if settings["autoAdd"] == True: 
                ...
                cl.sendText(op.param1, "Halo " + xname + " ,terimakasih telah menambahkan saya sebagai teman lol :3")
        if op.type == 13:
            if mid in op.param3:
                    ...
                    if msg.toType == 2:
                        ...
                        if group.invitee is not None:
                            try:
                               ...
                               cl.sendText(msg.to,"Tidak Ada Invitan Yang Pending goblok:v")
    #==============================================================================#
    #================================= SELF GROUP =================================#
    #==============================================================================#
